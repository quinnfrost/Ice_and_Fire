...
public class GuiDragon extends EffectRenderingInventoryScreen<ContainerDragon> {
    ...
    protected void renderBg(@NotNull PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        Entity entity = referencedDragon;
    ...
    protected void renderEffects(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (referencedDragon != null) {
            updateEffects(referencedDragon);
            ...
            if (!collection.isEmpty() && j >= 32) {
                ...
                Iterable<MobEffectInstance> iterable = collection.stream().filter(net.minecraftforge.client.ForgeHooksClient::shouldRenderEffect).sorted().collect(
                ...
                if (flag) {
                    ...
                    if (mobeffectinstance != null) {
                        List<Component> list = List.of(this.getEffectName(mobeffectinstance), new TextComponent(
    ...
    public void updateEffects(LivingEntity livingEntity) {
        livingEntity.getActiveEffects().removeIf(mobEffectInstance -> {

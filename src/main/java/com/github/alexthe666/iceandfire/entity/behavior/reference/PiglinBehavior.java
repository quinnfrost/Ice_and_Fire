...
//    }
//
//    protected static void initMemories(Piglin pPiglin) {
//        int i = TIME_BETWEEN_HUNTS.sample(pPiglin.level.random);
...
//        pBrain.addActivity(Activity.CORE,
//                           0,
...
//                                            new StartCelebratingIfTargetDead(300, PiglinBehavior::wantsToDance),
...
//                           10,
//                           ImmutableList.of(new SetEntityLookTarget(PiglinBehavior::isPlayerHoldingLovedItem, 14.0F),
//                                            new StartAttacking<>(
//                                                    AbstractPiglin::isAdult,
//                                                    PiglinBehavior::findNearestValidAttackTarget
//                                            ),
...
//        pBrain.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT,
//                                                     10,
//                                                     ImmutableList.<net.minecraft.world.entity.ai.behavior.Behavior<? super Piglin>>of(
//                                                             new StopAttackingIfTargetInvalid<Piglin>((p_34981_) -> {
//                                                                 return !isNearestValidAttackTarget(pPiglin, p_34981_);
//                                                             }),
//                                                             new RunIf<>(PiglinBehavior::hasCrossbow,
//                                                                         new BackUpIfTooClose<>(5, 0.75F)
//                                                             ),
//                                                             new SetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F),
//                                                             new MeleeAttack(20),
//                                                             new CrossbowAttack(),
//                                                             new RememberIfHoglinWasKilled(),
//                                                             new EraseMemoryIf<>(PiglinBehavior::isNearZombified,
...
//        pBrain.addActivityAndRemoveMemoryWhenStopped(Activity.CELEBRATE,
//                                                     10,
//                                                     ImmutableList.of(avoidRepellent(),
//                                                                      new SetEntityLookTarget(PiglinBehavior::isPlayerHoldingLovedItem,
//                                                                                              14.0F
//                                                                      ),
//                                                                      new StartAttacking<Piglin>(AbstractPiglin::isAdult,
//                                                                                                 PiglinBehavior::findNearestValidAttackTarget
//                                                                      ),
//                                                                      new RunIf<Piglin>((p_34804_) -> {
//                                                                          return !p_34804_.isDancing();
//                                                                      }, new GoToCelebrateLocation<>(2, 1.0F)),
//                                                                      new RunIf<Piglin>(Piglin::isDancing,
//                                                                                        new GoToCelebrateLocation<>(4,
//                                                                                                                    0.6F
//                                                                                        )
//                                                                      ),
//                                                                      new RunOne<>(ImmutableList.of(
//                                                                              Pair.of(new SetEntityLookTarget(EntityType.PIGLIN,
//                                                                                                              8.0F
//                                                                              ), 1),
...
//        pBrain.addActivityAndRemoveMemoryWhenStopped(Activity.ADMIRE_ITEM,
//                                                     10,
//                                                     ImmutableList.of(new GoToWantedItem<>(PiglinBehavior::isNotHoldingLovedItemInOffHand,
//                                                                                           1.0F,
//                                                                                           true,
//                                                                                           9
//                                                                      ),
//                                                                      new StopAdmiringIfItemTooFarAway<>(9),
//                                                                      new StopAdmiringIfTiredOfTryingToReachItem<>(200,
//                                                                                                                   200
//                                                                      )
//                                                     ),
...
//        pBrain.addActivityAndRemoveMemoryWhenStopped(Activity.AVOID,
//                                                     10,
//                                                     ImmutableList.of(SetWalkTargetAwayFrom.entity(MemoryModuleType.AVOID_TARGET,
//                                                                                                   1.0F,
//                                                                                                   12,
//                                                                                                   true
//                                                                      ),
//                                                                      createIdleLookBehaviors(),
//                                                                      createIdleMovementBehaviors(),
//                                                                      new EraseMemoryIf<Piglin>(PiglinBehavior::wantsToStopFleeing,
...
//        pBrain.addActivityAndRemoveMemoryWhenStopped(Activity.RIDE,
//                                                     10,
//                                                     ImmutableList.of(new Mount<>(0.8F),
//                                                                      new SetEntityLookTarget(PiglinBehavior::isPlayerHoldingLovedItem,
//                                                                                              8.0F
//                                                                      ),
//                                                                      new RunIf<>(
...
//                                                                              createIdleLookBehaviors()
//                                                                      ),
//                                                                      new DismountOrSkipMounting<>(8,
//                                                                                                   PiglinBehavior::wantsToStopRiding
//                                                                      )
//                                                     ),
...
//                                             Pair.of(InteractWith.of(EntityType.PIGLIN,
//                                                                     8,
//                                                                     MemoryModuleType.INTERACTION_TARGET,
//                                                                     0.6F,
//                                                                     2
//                                             ), 2),
//                                             Pair.of(new RunIf<>(PiglinBehavior::doesntSeeAnyPlayerHoldingLovedItem,
...
//        return new CopyMemoryWithExpiry<>(Piglin::isBaby,
...
//        return new CopyMemoryWithExpiry<>(PiglinBehavior::isNearZombified,
...
//        return loottable.getRandomItems((new LootContext.Builder((ServerLevel) pPiglin.level)).withParameter(
//                LootContextParams.THIS_ENTITY,
//                pPiglin
//        ).withRandom(pPiglin.level.random).create(LootContextParamSets.PIGLIN_BARTER));
//    }
//
...
//        } else {
//            Optional<LivingEntity> optional = BehaviorUtils.getLivingEntityFromUUIDMemory(p_35001_,
...
//                    return optional2.isPresent() && Sensor.isEntityAttackable(p_35001_,
//                                                                              optional2.get()
...
//        list.stream().filter(PiglinBehavior::isIdle).filter((p_34881_) -> {
...
//        Brain<Piglin> brain = pPiglin.getBrain();
//        return !brain.hasMemoryValue(MemoryModuleType.AVOID_TARGET) ? false : brain.getMemory(MemoryModuleType.AVOID_TARGET).get().closerThan(
//                pPiglin,
//                12.0D
//        );
//    }
...
//        return pPiglin.getBrain().hasMemoryValue(MemoryModuleType.HUNTED_RECENTLY) || getVisibleAdultPiglins(pPiglin).stream().anyMatch(
//                (p_34995_) -> {
...
//        return new RunSometimes<>(new CopyMemoryWithExpiry<>(Piglin::isBaby,
...
//        getVisibleAdultPiglins(pPiglin).forEach(PiglinBehavior::dontKillAnyMoreHoglinsForAWhile);
//    }
//
...
//        return pPiglin.getBrain().hasMemoryValue(MemoryModuleType.AVOID_TARGET) ? pPiglin.getBrain().getMemory(
//                MemoryModuleType.AVOID_TARGET) : Optional.empty();
//    }
//
//    public static Optional<Player> getNearestVisibleTargetablePlayer(AbstractPiglin pPiglin) {
//        return pPiglin.getBrain().hasMemoryValue(MemoryModuleType.NEAREST_VISIBLE_ATTACKABLE_PLAYER) ? pPiglin.getBrain().getMemory(
//                MemoryModuleType.NEAREST_VISIBLE_ATTACKABLE_PLAYER) : Optional.empty();
//    }
//
...
//        Brain<Piglin> brain = pPiglin.getBrain();
//        LivingEntity $$3 = BehaviorUtils.getNearestTarget(pPiglin,
...
//        pPiglin.getBrain().eraseMemory(MemoryModuleType.WALK_TARGET);
//        pPiglin.getBrain().setMemoryWithExpiry(MemoryModuleType.AVOID_TARGET,
//                                               pTarget,
//                                               (long) RETREAT_DURATION.sample(pPiglin.level.random)
//        );
//        dontKillAnyMoreHoglinsForAWhile(pPiglin);
//    }
//
//    protected static void dontKillAnyMoreHoglinsForAWhile(AbstractPiglin p_34923_) {
//        p_34923_.getBrain().setMemoryWithExpiry(MemoryModuleType.HUNTED_RECENTLY,
//                                                true,
//                                                (long) TIME_BETWEEN_HUNTS.sample(p_34923_.level.random)
//        );
//    }
//
...
//        return p_34884_.getType() == EntityType.PLAYER && p_34884_.isHolding(PiglinBehavior::isLovedItem);
//    }
//
